...
public class PullToRefreshViewUp extends LinearLayout {
	...
	public PullToRefreshViewUp(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshViewUp(Context context) {
		super(context);
		init();
	}
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterState != RELEASE_TO_REFRESH) {
			mFooterTextView.setText("继续拖动，查看图文详情");
