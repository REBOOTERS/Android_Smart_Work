...
public class PullToRefreshViewDown extends LinearLayout {
	 ...
	 */
	private OnFooterRefreshListenerDown mOnFooterRefreshListener;
	/**
	 * footer refresh listener
	 */
	private OnHeaderRefreshListenerDown mOnHeaderRefreshListener;
	...
	public PullToRefreshViewDown(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullToRefreshViewDown(Context context) {
		super(context);
		init();
	}
...
//				return true;
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText("继续拖动，查看商品详情");
...
//		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
	 ...
	 */
	public void setOnHeaderRefreshListener(OnHeaderRefreshListenerDown headerRefreshListener) {
		mOnHeaderRefreshListener = headerRefreshListener;
	}

	public void setOnFooterRefreshListener(OnFooterRefreshListenerDown footerRefreshListener) {
	 ...
	 */
	public interface OnFooterRefreshListenerDown {
		public void onFooterRefresh(PullToRefreshViewDown view);
	}
	 ...
	 * view should be refreshed.
	 */
	public interface OnHeaderRefreshListenerDown {
