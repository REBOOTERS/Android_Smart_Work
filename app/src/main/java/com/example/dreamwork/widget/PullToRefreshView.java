...
//    private RelativeLayout mHeaderProgressBar;
    /**
     * footer progress bar
     */
    ...
    private void addHeaderView() {
        ...
        mHeaderView = mInflater
                .inflate(R.layout.refresh_header_common, this, false);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.refresh_footer_common, this, false);
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
            ...
            mFooterImageView.clearAnimation();
            mFooterImageView.startAnimation(mFlipAnimation);
            mFooterTextView.setText("继续上拉，加载更多");
